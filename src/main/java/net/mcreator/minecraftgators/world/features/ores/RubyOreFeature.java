...
public class RubyOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("minecraft_gators:ruby_ore", FEATURE,
				new OreConfiguration(RubyOreFeatureRuleTest.INSTANCE, MinecraftGatorsModBlocks.RUBY_ORE.get().defaultBlockState(), 2));
		PLACED_FEATURE = PlacementUtils.register("minecraft_gators:ruby_ore", CONFIGURED_FEATURE,
	...
	private static class RubyOreFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("minecraft_gators:ruby_ore_match"), CUSTOM_MATCH);
		}
