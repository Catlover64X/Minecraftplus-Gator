...
public class CatShitFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		FEATURE = new CatShitFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("minecraft_gators:cat_poop", FEATURE,
				new OreConfiguration(CatShitFeatureRuleTest.INSTANCE, MinecraftGatorsModBlocks.CAT_POOP.get().defaultBlockState(), 16));
		PLACED_FEATURE = PlacementUtils.register("minecraft_gators:cat_poop", CONFIGURED_FEATURE,
	...
	private static class CatShitFeatureRuleTest extends RuleTest {
		...
		private static final com.mojang.serialization.Codec<CatShitFeatureRuleTest> CODEC = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		private static final RuleTestType<CatShitFeatureRuleTest> CUSTOM_MATCH = () -> CODEC;

		@SubscribeEvent
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("minecraft_gators:cat_poop_match"), CUSTOM_MATCH);
		}
