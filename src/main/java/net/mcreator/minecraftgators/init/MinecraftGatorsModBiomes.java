...
import net.mcreator.minecraftgators.world.biome.CatDesertBiome;
...
public class MinecraftGatorsModBiomes {
	public static final DeferredRegister<Biome> REGISTRY = DeferredRegister.create(ForgeRegistries.BIOMES, MinecraftGatorsMod.MODID);
	public static final RegistryObject<Biome> CAT_FOOD_PLAINS = REGISTRY.register("cat_food_plains", () -> CatFoodPlainsBiome.createBiome());
	public static final RegistryObject<Biome> CAT_FOOD_HILLS = REGISTRY.register("cat_food_hills", () -> CatFoodHillsBiome.createBiome());
	public static final RegistryObject<Biome> CAT_DESERT = REGISTRY.register("cat_desert", () -> CatDesertBiome.createBiome());
			...
			for (Map.Entry<ResourceKey<LevelStem>, LevelStem> entry : worldGenSettings.dimensions().entrySet()) {
				...
				if (dimensionType == dimensionTypeRegistry.getOrThrow(DimensionType.OVERWORLD_LOCATION)) {
					...
					if (chunkGenerator.getBiomeSource() instanceof MultiNoiseBiomeSource noiseSource) {
						...
						parameters.add(new Pair<>(CatFoodPlainsBiome.PARAMETER_POINT,
								biomeRegistry.getOrCreateHolder(ResourceKey.create(Registry.BIOME_REGISTRY, CAT_FOOD_PLAINS.getId()))));
					...
					if (chunkGenerator instanceof NoiseBasedChunkGenerator noiseGenerator) {
						...
						if (currentRuleSource instanceof SurfaceRules.SequenceRuleSource sequenceRuleSource) {
							...
							surfaceRules.add(1,
									preliminarySurfaceRule(ResourceKey.create(Registry.BIOME_REGISTRY, CAT_FOOD_PLAINS.getId()),
											MinecraftGatorsModBlocks.CAT_FOOD_BLOCK.get().defaultBlockState(), Blocks.STONE.defaultBlockState(),
